...
const revenueCategories = [
  { name: "Game Development", icon: Gamepad2, color: "#3b82f6" },
  { name: "Bahasa Pemrograman", icon: Code2, color: "#10b981" },
  { name: "Desktop App", icon: Monitor, color: "#8b5cf6" },
  { name: "Database & Sistem", icon: Database, color: "#f59e0b" },
  { name: "Tools & Version Control", icon: Wrench, color: "#ec4899" },
]
...
const initialData = revenueCategories.map((cat, i) => ({
  ...cat,
  value: 14 + i * 4,
}))
...
export function AnimatedRevenueChart() {
  ...
  const [totalRevenue, setTotalRevenue] = useState(() => initialData.reduce((s, v) => s + v.value, 0))
    ...
    >
      <div className="mb-8 flex items-center justify-between">
        ...
        <div className="text-right">
          ...
          >
            {totalRevenue.toLocaleString("en-US")} stack
          </motion.p>
          <motion.div
            key={growth}
            initial={{ opacity: 0 }}
          ...
          >
            ...
            <p className="text-sm font-medium text-emerald-600">+{growth}% fokus</p>
          </motion.div>
        </div>
      </div>
          ...
          return (
            ...
            >
              ...
              <div className="text-right">
                ...
                >
                  {item.value.toLocaleString("en-US")} pts
                </motion.span>
